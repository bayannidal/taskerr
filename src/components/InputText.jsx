...
export const InputText = ({
  ...
  return (
    <input
      ...
      }  w-full font-medium rounded-lg text-[0.5rem] placeholder:text-[0.5rem] sm:text-base md:text-base sm:placeholder:text-[0.8rem] placeholder:md:text-base p-3 mb-2  text-text dark:text-white caret-third placeholder:font-medium custom-shadow focus:bg-third focus:bg-opacity-30 dark:focus:bg-third dark:focus:bg-opacity-30`}
    />
  );
};
// focus:bg-[rgba(240,214,133,0.3)] dark:focus:bg-[rgba(240,214,133,0.3)]
